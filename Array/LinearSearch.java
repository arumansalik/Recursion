...
public class LinearSearch {
    public static void main(String[] args) {
        int[] arr = {10, 20, 30, 40, 40, 70, 40};
        System.out.println(search(arr, 70, 0));
        System.out.println(search1(arr, 70,  0));
        System.out.println(search2(arr, 70,  arr.length-1));
        findAllIndex(arr, 40, 0);
        System.out.println(list);
        ArrayList<Integer> ans = findAllIndex1(arr, 40, 0, new ArrayList<>());
    ...
    static ArrayList<Integer> findAllIndex2(int[] arr, int target, int index) {
        ...
        ArrayList<Integer> ansFromBelowCalls =  findAllIndex1(arr, target, index + 1, list);
